...
def token_metric(true:list,predict:list):
    ...
    f_ind = token_metrics["f1-ind"]
    r_ind = token_metrics["recall-ind"]
    p_ind = token_metrics["precision-ind"]
...
def rose_metric(test_true_lines:list,test_pred_lines:list):
    ...
    # rose_f1_25_ind = round(nsd_metrics_25["f1-ind"], 2)
    # rose_f1_50_ind = round(nsd_metrics_50["f1-ind"], 2)
    # rose_f1_75_ind = round(nsd_metrics_75["f1-ind"], 2)
    # rose_f1_100_ind = round(nsd_metrics_100["f1-ind"], 2)
    # rose_p_25_ind =round(nsd_metrics_25["precision-ind"], 2)
    # rose_p_50_ind = round(nsd_metrics_50["precision-ind"], 2)
    # rose_p_75_ind = round(nsd_metrics_75["precision-ind"], 2)
    # rose_p_100_ind = round(nsd_metrics_100["precision-ind"], 2)
    # rose_r_25_ind = round(nsd_metrics_25["recall-ind"], 2)
    # rose_r_50_ind = round(nsd_metrics_50["recall-ind"], 2)
    # rose_r_75_ind = round(nsd_metrics_75["recall-ind"], 2)
    # rose_r_100_ind = round(nsd_metrics_100["recall-ind"], 2)

    # rose_f1_25_overall = round(nsd_metrics_25["f1-overall"], 2)
    # rose_f1_50_overall = round(nsd_metrics_50["f1-overall"], 2)
    # rose_f1_75_overall = round(nsd_metrics_75["f1-overall"], 2)
    # rose_f1_100_overall = round(nsd_metrics_100["f1-overall"], 2)
    # rose_p_25_overall =round(nsd_metrics_25["precision-overall"], 2)
    # rose_p_50_overall = round(nsd_metrics_50["precision-overall"], 2)
    # rose_p_75_overall = round(nsd_metrics_75["precision-overall"], 2)
    # rose_p_100_overall = round(nsd_metrics_100["precision-overall"], 2)
    # rose_r_25_overall = round(nsd_metrics_25["recall-overall"], 2)
    # rose_r_50_overall = round(nsd_metrics_50["recall-overall"], 2)
    # rose_r_75_overall = round(nsd_metrics_75["recall-overall"], 2)
    # rose_r_100_overall = round(nsd_metrics_100["recall-overall"], 2)


    
    # print(f"=====> ROSE(Experiment) <=====(OverRall)")
    # print(f"ROSE-25%:  f:{rose_f1_25_overall}, p:{rose_p_25_overall}, r:{rose_r_25_overall}")
    # print(f"ROSE-50%:  f:{rose_f1_50_overall}, p:{rose_p_50_overall}, r:{rose_r_50_overall}")
    # print(f"ROSE-75%:  f:{rose_f1_75_overall}, p:{rose_p_75_overall}, r:{rose_r_75_overall}")
    # print(f"ROSE-100%:  f:{rose_f1_100_overall}, p:{rose_p_100_overall}, r:{rose_r_100_overall}")

    # print(f"=====> ROSE(Experiment) <=====(Ind)")
    # print(f"ROSE-25%:  f:{rose_f1_25_ind}, p:{rose_p_25_ind}, r:{rose_r_25_ind}")
    # print(f"ROSE-50%:  f:{rose_f1_50_ind}, p:{rose_p_50_ind}, r:{rose_r_50_ind}")
    # print(f"ROSE-75%:  f:{rose_f1_75_ind}, p:{rose_p_75_ind}, r:{rose_r_75_ind}")
    # print(f"ROSE-100%:  f:{rose_f1_100_ind}, p:{rose_p_100_ind}, r:{rose_r_100_ind}")

    # print(f"=====> ROSE(Experiment) <=====(NSD)")
